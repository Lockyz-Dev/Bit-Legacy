module.exports = (client) => {
    ...
    client.loadCommand = (cmdName) => {
        try {
            ...
            if(props.help.category === "moderation")
            {
                client.categories.moderation.set(props.help.name, props.help.name);
            }
            if(props.help.category === "info")
            {
                client.categories.info.set(props.help.name, props.help.name);
            }
            if(props.help.category === "level")
            {
                client.categories.level.set(props.help.name, props.help.name);
            }
            if(props.help.category === "settings")
            {
                client.categories.settings.set(props.help.name, props.help.name);
            }
            if(props.help.category === "giveaway")
            {
                client.categories.giveaway.set(props.help.name, props.help.name);
            }
            return;
        } catch (err) {
